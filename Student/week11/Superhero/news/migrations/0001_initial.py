# Generated by Django 5.1.1 on 2024-11-07 20:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('investigator', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='news.investigator')),
            ],
        ),
        migrations.CreateModel(
            name='Superhero',
            fields=[
                ...
                ('investigator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='superheroes', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
